...
public interface LinearProgramSolver {
     ...
     * automatically transferred by the <code>solve</code> method. Therefore, this
     ...
     * Usually, this method is needed and used by the programmers in deeper parts
    ...
    /**
     * Returns the name of this linear program solver. This method is needed if a specific solver
     * is requested from the solver factory.
     *
    ...
    /**
     * Returns the names of any system library that the solver depends on. Before returning an instance
     * of the requested solver, the {@link SolverFactory} ensures that the required libraries are loaded.
     * If the solver factory failed to load any library, it will not return an instance of this solver.
     *
