...
//			int nonzero = (int) st.nval;
	...
	/* (non-Javadoc)
	 * @see org.lplibs4j.api.util.Matrix#get(int, int)
	 */
    /**
    ...
    /* (non-Javadoc)
     * @see org.lplibs4j.api.util.Matrix#getRowNum()
     */
    ...
    /* (non-Javadoc)
     * @see org.lplibs4j.api.util.Matrix#getColNum()
     */
	...
	/* (non-Javadoc)
	 * @see org.lplibs4j.api.util.Matrix#transpose()
	 */
    /**
...
//		ListIterator<SparseVector> rowIterator = this.vvectorlist.listIterator();
	...
	/* (non-Javadoc)
	 * @see org.lplibs4j.api.util.Matrix#times(org.lplibs4j.api.util.Matrix)
	 */
    /**
